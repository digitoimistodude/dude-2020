 ...
 * @Date:   2021-02-09 15:43:38
 * @Last Modified by:   Roni Laukkarinen
 * @Last Modified time: 2022-04-23 11:19:42
 */
/**
...
const LiquidButton = class LiquidButton {
  constructor(svg) {
    ...
    this.color1 = options.color1 || '#7effe1';
    this.color2 = options.color2 || '#161826';
    this.color3 = options.color3 || '#131a50';
    ...
    this.svgText.setAttribute('font-size', '17px');
    this.svgText.style.fontFamily = 'Circular';
